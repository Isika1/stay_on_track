...
class HabitTile extends StatelessWidget {
  ...
  final VoidCallback onTap; // for playbutton
  //VoidCallback is a type of gesture detector
  final VoidCallback settingsTapped; //for settings button
  final int timeSpent;
  final int timeGoal;
  ...
  //convert seconds into minsec ->  e.g 62 seconds = 1:02 min
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: Color.fromARGB(255, 241, 227, 72),
